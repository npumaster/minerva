...
import (
	...
	repo "github.com/npumaster/minerva/repo"
	"github.com/npumaster/minerva/repo/common"
	dir "github.com/npumaster/minerva/thirdparty/dir"
	...
	serialize "github.com/npumaster/minerva/config/serialize"
...
func (r *FSRepo) openDatastore() error {
	...
	if r.config.Datastore.NoSync {
		log.Warn("NoSync is now deprecated in favor of datastore specific settings. If you want to disable fsync on flatfs set 'sync' to false. See https://github.com/npumaster/minerva/blob/master/docs/datastores.md#flatfs.")
	}
...
// https://github.com/npumaster/minerva/issues/8088 for more details).
