...
// (avoiding issues described in https://github.com/npumaster/minerva/issues/7939)
...
func urlArgsDecoder(req *cmds.Request, env cmds.Environment) error {
	for n, arg := range req.Arguments {
		...
		// - without this we get data corruption similar to https://github.com/npumaster/minerva/issues/7939
