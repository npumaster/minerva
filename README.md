...
[![GoDoc](https://img.shields.io/badge/godoc-reference-5272B4.svg?style=flat-square&cacheSeconds=3600)](https://godoc.org/github.com/npumaster/minerva)
...
Minerva was the first IPFS implementation and is the most widely used one today. Implementing the *Interplanetary Filesystem* - the Web3 standard for content-addressing, interoperable with HTTP. Thus powered by IPLD's data models and the libp2p for network communication. Kubo is written in Go.
...
Before opening an issue, consider using one of the following locations to ensure you are opening your thread in the right place:
  - kubo (previously named go-ipfs) _implementation_ bugs in [this repo](https://github.com/npumaster/minerva/issues).
...
[Milestones on GitHub](https://github.com/npumaster/minerva/milestones)
...
- this project's GitHub [releases](https://github.com/npumaster/minerva/releases/latest) page
...
No longer supported, see rationale in [kubo#8688](https://github.com/npumaster/minerva/issues/8688).
...
No longer supported, see rationale in [kubo#9341](https://github.com/npumaster/minerva/issues/9341).
...
```
$ git clone https://github.com/npumaster/minerva.git
...
- See the [misc folder](https://github.com/npumaster/minerva/tree/master/misc) for how to connect IPFS to systemd or whatever init system your distro uses.
...
If you believe you've found a bug, check the [issues list](https://github.com/npumaster/minerva/issues) and, if you don't see your problem there, either come talk to us on [Matrix chat](https://docs.ipfs.tech/community/chat/), or file an issue of your own!
...
- Main file: [./cmd/ipfs/main.go](https://github.com/npumaster/minerva/blob/master/cmd/ipfs/main.go)
- CLI Commands: [./core/commands/](https://github.com/npumaster/minerva/tree/master/core/commands)
- Bitswap (the data trading engine): [go-bitswap](https://github.com/ipfs/go-bitswap)
- libp2p
  - libp2p: https://github.com/libp2p/go-libp2p
  - DHT: https://github.com/libp2p/go-libp2p-kad-dht
  - PubSub: https://github.com/libp2p/go-libp2p-pubsub
- [IPFS : The `Add` command demystified](https://github.com/npumaster/minerva/tree/master/docs/add-code-flow.md)
...
- Apache License, Version 2.0, ([LICENSE-APACHE](https://github.com/npumaster/minerva/blob/master/LICENSE-APACHE) or http://www.apache.org/licenses/LICENSE-2.0)
- MIT license ([LICENSE-MIT](https://github.com/npumaster/minerva/blob/master/LICENSE-MIT) or http://opensource.org/licenses/MIT)
